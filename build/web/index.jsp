    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="sr_empleado" method="post" class="form-group">
                ...
                <br>
                    <button name="btn_agregar" id="btn_agregar" value="agregar" class="btn btn-info"><i class="bi bi-cloud-arrow-up-fill"></i> Agregar</button>
                    <button name="btn_modificar" id="btn_modificar"  value="modificar" class="btn btn-warning"><i class="bi bi-arrow-left-right"></i> Modificar</button>
                    <button name="btn_eliminar" id="btn_eliminar"  value="eliminar"  class="btn btn-danger" onclick="javascript:if(!confirm('¿Desea Eliminar?'))return false" ><i class="bi bi-cloud-arrow-down-fill"></i> Eliminar</button>
